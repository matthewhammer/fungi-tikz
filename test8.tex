...
\begin{tikzpicture}[
  ...
  { [start chain]
    ...
    \node (a5) [consV,on chain=going below] {$n_5$\nodepart{second}{\Num{2}}};
    {
      [start branch=a5t]            
    ...
    \node (p5) [on chain=going below] {};
    {
      [start branch=a4]
      \node (pad) [pad, on chain=going right,minimum size=15mm] {};
      \node (b51) [path,on chain=going right] {};
      \node (b52) [path,on chain=going right] {};
      \node (b53) [path,on chain=going right] {};
      \node (b54) [path,on chain=going right] {};
      \node (b55) [kv,on chain=going right] {$n_5$\nodepart{second}{\Num{2}}};
      \node (o5) [consV,on chain=going right] {$n_5$\nodepart{second}{\Num{2}}};      
   }
   \node (a6) [nil,on chain=going below] {nil};
   {
     [start branch=a4t]
     \node (a6t) [thunk,on chain=going right] {$\texttt{dedup}~a_6$};
   }
  ...
  \begin{pgfonlayer}{background}
    ...
    \draw (a6t.north west)+(-3pt,5pt) node {$n_5{\cdot}\textrm{t}$};
...
w    \path (b52.south)+(0,0) node (b32s) {};
    ...
    \path (a5.north |- a5.west)+(-0.45,-0.85) node (a2x) {};
    \path (a5.south |- a5.east)+(+0.45,+0.85) node (a2y) {};
    \path[fill=green!10,rounded corners, line width=1.5pt, draw=black]
    (a2x) rectangle (a2y);
    \draw (a5.north west)+(-10pt,0) node {$a_5$};

    \path (o5.north) node (o5n) {};
    \path (o5.east) node (o5e) {};
    \path (o5.south |- o5.west)+(-0.45,-0.85) node (a1x) {};
    \path (o5.north |- o5.east)+(+0.45,+0.85) node (a1y) {};
    \path[fill=green!10,rounded corners, draw=black, line width=1.5pt, label=west:p1]
    (a1x) rectangle (a1y);
    \draw (o5.north west)+(-10pt,0) node {$n_5$};


    \path (a6.north)+(0,0)            node (a6n) {};
    \path (a6.east)+(0,0)             node (a6e) {};
    \path (a6.north |- a6.west)+(-0.42,-0.38) node (a2x) {};
    \path (a6.south |- a6.east)+(+0.42,+0.38) node (a2y) {};
    \path[fill=green!10,rounded corners, line width=1.5pt, draw=black]
    (a2x) rectangle (a2y);
    \draw (a6.north west)+(-10pt,0) node {$a_6$};
    ...
    \path[fill=green!10,rounded corners, draw=black, line width=1.5pt, label=west:p1]
    (a1x) rectangle (a1y);
    \draw (o6.north west)+(-10pt,0) node {$a_6$};
  ...
  \begin{pgfonlayer}{foreground}
    ...
    \path[bend right,draw=black,fill=black,>=stealth,thick, line width=1.2pt] (b11.second)+(0.091,.071) circle (1.3pt) edge[->] (b12w) {};

    \draw (b12.second)+(0.091,.071) node[nilcross] {};
    \path[bend left,draw=black,fill=black,>=stealth,thick, line width=1.2pt] (b12)+(0.021,.18) circle (1.3pt) edge[->] (b13w) {};

    \path[bend left,draw=black,fill=black,>=stealth,thick, line width=1.2pt] (b13)+(0.021,.18) circle (1.3pt) edge[->] (b14w) {};
    \draw (b13.second)+(0.091,0.071) node[nilcross] {};

    \draw (b14)+(0.021,0.18) node[nilcross] {};
    \path[bend right,draw=black,fill=black,>=stealth,thick, line width=1.2pt] (b14.second)+(0.091,.071) circle (1.3pt) edge[->] (b15w) {};

    \path[fill=black, draw=black,>=stealth,thick, line width=1.2pt] (a2.third)+(0.091,0.1) circle (1.3pt) edge[->] (a3n) {};
    \path[fill=black, draw=black,>=stealth,thick, line width=1.2pt] (o2.third)+(0.091,0.1) circle (1.3pt) edge[->] (o4n) {};
    ...
    \path[fill=black, draw=black,>=stealth,thick, line width=1.2pt] (o4.third)+(0.091,0.1) circle (1.3pt) edge[->] (o5n) {};
    \path[fill=black,draw=black,>=stealth,thick, line width=1.2pt] (a5.third)+(0.1,0.1) circle (1.3pt) edge[->] (a6n) {};
  ...
  \begin{pgfonlayer}{dcgbackground}
    ...
    \path[dotted, fill=blue!30!white, draw=blue!20!white,line width=6pt] (a5t)+(0,-9pt) edge[->] (a6t);

    %a6
    \path[dotted, fill=blue!30!white, draw=blue!30!white,line width=3pt] (a6t) edge[->] (a6e) node [above=2pt] {};
