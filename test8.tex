...
\begin{tikzpicture}[
  ...
  \begin{pgfonlayer}{background}
    ...
    \draw (a6t.north west)+(-3pt,5pt) node {$n_6{\cdot}\textrm{t}$};
    ...
    \path (b51.north west)+(0,0.45) node {$n_4{\cdot}\textrm{p}{\cdot}0$};
    ...
    \path (b52.north west)+(0,0.45) node {$n_4{\cdot}\textrm{p}{\cdot}1$};
...
w    \path (b52.south)+(0,0) node (b32s) {};
    ...
    \path (b53.north west)+(0,0.45) node {$n_4{\cdot}\textrm{p}{\cdot}2$};
    ...
    \path (b54.north west)+(0,0.45) node {$n_4{\cdot}\textrm{p}{\cdot}3$};
    ...
    \path (b55.north west)+(0,0.45) node {$n_4{\cdot}\textrm{p}{\cdot}4$};
