...
\begin{tikzpicture}[
  ...
  \begin{pgfonlayer}{foreground}
    ...
    \draw (b21)+(0.021,.18) node[nilcross] {};
    ...
    \path[bend right,draw=black,fill=black,>=stealth,thick] (b23)+(0.021,.18) circle (1.3pt) edge[->] (b14s) {};
    ...
    \path[bend left, fill=black, draw=black,>=stealth,thick] (o4.third)+(0.091,0.1) circle (1.3pt) edge[->] (o5e) {};
