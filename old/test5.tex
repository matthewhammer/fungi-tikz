...
\pgfdeclarelayer{edgebackground}
\pgfdeclarelayer{background}
\pgfdeclarelayer{foreground}
\pgfsetlayers{edgebackground,background,main,foreground}
...
\begin{tikzpicture}[
  ...
  { [start chain]
    ...
    \node (a1) [consV,on chain=going below] {$n_1$\nodepart{second}{3}};
          {
            [start branch=a1]
            \node (a1t) [thunk,on chain=going right] {};
  ...
  \begin{pgfonlayer}{background}
    ...
    \path[fill=green!10,rounded corners, draw=black, line width=1pt, label=west:p1]
    (a1x) rectangle (a1y);
    ...
    \path[fill=green!10,rounded corners, draw=black, line width=1pt, label=west:p1]
    (a1x) rectangle (a1y);
    \draw (o5.north west)+(-10pt,0) node {$n_1$};
  ...
  \begin{pgfonlayer}{foreground}
    ...
    % Thunk effects: a1t
    \path[bend right,fill=blue!50!black, draw=blue!50!black,line width=3pt] (a1t)+(0,0.1) edge[->] (a1e) node [above=3pt] {};    
    %\path[bend right,fill=green!50!black, draw=blue!50!white,line width=3pt] (a1t.lower)+(0,0) edge[->] (b11w) node [below=2pt] {};
    \path[fill=blue!30!white, draw=blue!20!white,line width=4pt,>=stealth] (a1t)+(0,-9pt) edge[->] (a2t);
    ...
    % Thunk effects: a2t
    \path[bend right,fill=blue!50!black, draw=blue!50!black,line width=3pt] (a2t)+(0,0.1) edge[->] (a2e) node [above=2pt] {};

    %\path[bend right,fill=green!50!black, draw=blue!50!white,line width=3pt] (a2t.lower)+(0,0) edge[->] (b21w) node [below=2pt] {};
    \path[fill=blue!30!white, draw=blue!20!white,line width=4pt,>=stealth] (a2t)+(0,-9pt) edge[->] (a3t);
    
    \path[bend right,draw=black,fill=black,>=stealth,thick] (b21.second)+(0.091,.071) circle (1.3pt) edge[->] (b22w) {};
    \path[bend right,draw=black,fill=black,>=stealth,thick] (b22)+(0.021,.18) circle (1.3pt) edge[->] (b23) {};
    ...
    %\path[fill=black, draw=black,>=stealth,thick] (o3.third)+(0.091,0.1) circle (1.3pt) edge[->] (o4n) {};
    ...
    % Thunk effects: a4t
    \path[bend right,fill=blue!50!black, draw=blue!50!black,line width=3pt] (a4t)+(0,0.1) edge[->] (a4e) node [above=2pt] {};
    ...
    \path[bend right,draw=black,fill=black,>=stealth,thick] (b41)+(0.021,.18)  circle (1.3pt) edge[->] (b42) {};
    \path[bend right,draw=black,fill=black,>=stealth,thick] (b42)+(0.021,.18)  circle (1.3pt) edge[->] (b43) {};
    \path[bend right,draw=black,fill=black,>=stealth,thick] (b43.second)+(0.091,.071)  circle (1.3pt) edge[->] (b44) {};

    % Thunk effects: a5t
    \path[bend right,fill=blue!50!black, draw=blue!50!black,line width=3pt] (a5t)+(0,0.1) edge[->] (a5e) node [above=2pt] {};


  \end{pgfonlayer}

  \begin{pgfonlayer}{edgebackground}
    \path[bend right,fill=blue!50!white, draw=blue!50!white,line width=2pt] (a2t)+(0,0.1) edge[->] (b11s)+(0,-0.1) node [above=3pt] {};
    \path[bend right,fill=blue!50!white, draw=blue!50!white,line width=2pt] (a2t)+(0,0.1) edge[->] (b12s)+(0,-0.1) node [above=3pt] {};
    \path[bend right,fill=blue!50!white, draw=blue!50!white,line width=2pt] (a2t)+(0,0.1) edge[->] (b13s)+(0,-0.1) node [above=3pt] {};

    \path[bend right,fill=blue!50!white, draw=blue!50!white,line width=2pt] (a3t)+(0,0.1) edge[->] (b21)+(0,-0.1) node [above=3pt] {};
    \path[bend right,fill=blue!50!white, draw=blue!50!white,line width=2pt] (a3t)+(0,0.1) edge[->] (b22)+(0,-0.1) node [above=3pt] {};
    \path[bend right,fill=blue!50!white, draw=blue!50!white,line width=2pt] (a3t)+(0,0.1) edge[->] (b23)+(0,-0.1) node [above=3pt] {};
    
    \path[bend right,fill=blue!50!white, draw=blue!50!white,line width=2pt] (a4t)+(0,0.1) edge[->] (b31)+(0,-0.1) node [above=3pt] {};
    \path[bend right,fill=blue!50!white, draw=blue!50!white,line width=2pt] (a4t)+(0,0.1) edge[->] (b32)+(0,-0.1) node [above=3pt] {};
    \path[bend right,fill=blue!50!white, draw=blue!50!white,line width=2pt] (a4t)+(0,0.1) edge[->] (b33)+(0,-0.1) node [above=3pt] {};
