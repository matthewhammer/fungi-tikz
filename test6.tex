...
\begin{tikzpicture}[
  ...
  { [start chain]
    ...
    {
      [start branch=a1]
      \node (pad) [on chain=going right,minimum size=5mm] {};
  ...
  \begin{pgfonlayer}{background}
    ...
    \draw (a1t.north west)+(-9pt,8pt) node {$n_0{\cdot}\textrm{t}$};
    \draw (a2t.north west)+(-9pt,8pt) node {$n_1{\cdot}\textrm{t}$};
    \draw (a3t.north west)+(-9pt,8pt) node {$n_2{\cdot}\textrm{t}$};
    \draw (a4t.north west)+(-9pt,8pt) node {$n_3{\cdot}\textrm{t}$};
    \draw (a5t.north west)+(-9pt,8pt) node {$n_4{\cdot}\textrm{t}$};
    ...
    \path[fill=green!10] (b22.north west)+(0,0.45) node (b22n) {$n_2{\cdot}\textrm{p}{\cdot}0$};
    ...
    \path[fill=green!10] (b31.north west)+(0,0.45) node (b22n) {$n_3{\cdot}\textrm{p}{\cdot}0$};
    ...
    \path[fill=green!10] (b41.north west)+(0,0.45) node (b22n) {$n_4{\cdot}\textrm{p}{\cdot}0$};
