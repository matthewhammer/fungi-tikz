\begin{tikzpicture}
  ...
  \begin{pgfonlayer}{background}
    ...
    \draw (a1t.north)+(-0pt,10pt) node {$\textsf{comp}$};
    \draw (a2t.north west)+(-1pt,7pt) node {$\NmBinOp{\NmStr{dd}}{n_1}$};
    \draw (a3t.north west)+(-1pt,7pt) node {$\NmBinOp{\NmStr{dd}}{n_2}$};
    \draw (a4t.north west)+(-1pt,7pt) node {$\NmBinOp{\NmStr{dd}}{n_3}$};
    \draw (a5t.north west)+(-1pt,7pt) node {$\NmBinOp{\NmStr{dd}}{n_4}$};
    ...
    \RefLeaf{b15}{$\NmBinOp{\NmStr{t}}{\NmBinOp{n_1}{\NmNum{4}}}$}
    ...
    %%%%%%%%%
    \RefConsOut{o1}{$\NmBinOp{\NmStr{r}}{n_1}$}
  ...
  \begin{pgfonlayer}{foreground}
    ...
    \LeftNilPtr{b11}    
    \RightRefPtr{b11}{b12w}    
    \LeftRefPtr{b12}{b13w}
    \RightNilPtr{b12}    
    \LeftRefPtr{b13}{b14w}
    \RightNilPtr{b13}    
    \LeftNilPtr{b14}
    \RightRefPtr{b14}{b15w}
  ...
  \begin{pgfonlayer}{dcgbackground}
    %a1
    \path[dcgrefget] (a1t) edge[->]   (a1e) node [above=3pt] {};
    ...
    %a3
    \path[dcgrefget] (a3t) edge[->] (a3e) node [above=2pt] {};
    \path[dcgrefget, bend right] (a3t) edge[->] (b21sw)+(0,-0.1) node [above=3pt] {};
    \path[dcgrefget, bend right=40mm] (a3t) edge[->] (b12sw)+(0,-0.1) node [above=3pt] {};
    \path[dcgrefget, bend right=40mm] (a3t) edge[->] (b13sw)+(0,-0.1) node [above=3pt] {};
    \path[dcgrefget, bend right=40mm] (a3t) edge[->] (b14sw)+(0,-0.1) node [above=3pt] {};
    \path[dcgrefget, bend right=35mm] (a3t) edge[->] (b15sw)+(0,-0.1) node [above=3pt] {};
    \path[dcgthunkforce] (a3t) edge[->] (a4t);
